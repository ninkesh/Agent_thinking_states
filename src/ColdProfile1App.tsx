/**
 * ColdProfile1App — cold_profile_1 route.
 * Route: /cold_profile_1 or /cold-profile-1
 *
 * Content source: Glance_TV_Warm_Start_Profiles_v6.docx — Profile 1 (Gold Star / Akshay).
 * 1-signal structure. CTA injected per card from coldProfile1Data.ts.
 * All signal, layout, animations, and feed behaviour inherited from WarmProfile1CrisperApp.
 */
...
import ColdProfile1L0Glance from './components/L0/ColdProfile1L0Glance';
...
export default function ColdProfile1App() {
