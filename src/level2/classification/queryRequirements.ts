...
const ATTRIBUTE_RULES: AttributeRule[] = [
  ...
  { key: 'availability', patterns: [/\btimings?\b/i, /\bslots?\b/i, /\bschedule\b/i, /\bavailability\b/i, /\bopen(ing)?\s+hours?\b/i, /\bopen\s+late\b/i, /\blate[-\s]?night\b/i, /\btonight\b/i, /\bthis weekend\b/i, /\bavailable\b/i] },
  ...
  { key: 'gender', patterns: [/\bmale\b/i, /\bfemale\b/i, /\bboys?\b/i, /\bgirls?\b/i, /\bmen\b/i, /\bwomen\b/i, /\bunisex\b/i] },
